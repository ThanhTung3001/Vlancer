...
namespace TSoft.TaskManagement.Application.UnitTests.Common.Exceptions;
...
public class ValidationExceptionTests
{
        ...
        MulitpleValidationFailureForMultiplePropertiesCreatesAMultipleElementErrorDictionaryEachWithMultipleValues()
    {
        ...
        actual["Age"].Should().BeEquivalentTo(new string[] { "must be 25 or younger", "must be 18 or older", });
